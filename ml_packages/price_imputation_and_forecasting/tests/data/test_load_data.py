...
import pandas as pd
import os
from price_imputation_and_forecasting.data.load_data import load_store_data, load_price_data
...
class TestLoadData(unittest.TestCase):
    ...
    @patch("price_imputation_and_forecasting.data.load_data.pd.read_csv")
    @patch("price_imputation_and_forecasting.data.load_data.pd.read_excel")
    @patch("price_imputation_and_forecasting.data.load_data.os.path.exists")
    ...
    @patch("price_imputation_and_forecasting.data.load_data.pd.read_parquet")
    @patch("price_imputation_and_forecasting.data.load_data.os.path.exists")
