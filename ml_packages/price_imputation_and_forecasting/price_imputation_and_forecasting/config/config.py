...
class Config:
    def __init__(self, default_config_path=None, custom_config_path=None):
        ...
        """
        try:
            # Determine the path to the ffnn_gru_config.yaml relative to this module's location
            if default_config_path is None:
                default_config_path = Path(__file__).resolve().parent / 'ffnn_gru_config.yaml'
